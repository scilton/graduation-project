...
import 'change_password/store_change_password.dart';
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => StoreChangePassword()));
                        },
                        child: Row(
                        ...
                        onTap: (){
                          showMenu(
                            ...
                            position:CashHelper.getData(key: 'lang')=='ar'? RelativeRect.fromLTRB(0, height*.45, width, height*.55)
                                :RelativeRect.fromLTRB(width, height*.45, 0, height*.55),                         items: <PopupMenuEntry>[
                              PopupMenuItem(
                                value: 1,
                                onTap: (){
