...
import 'cubit/store_change_password_cubit.dart';
import 'cubit/store_change_password_states.dart';
class StoreChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
  create: (context) => StoreChangePasswordCubit(),
  child: BlocConsumer<StoreChangePasswordCubit, StoreChangePasswordStates>(
  listener: (context, state) {
    var cubit = StoreChangePasswordCubit.get(context);
  ...
  builder: (context, state) {
    ...
    children: [
      ...
      ConditionalBuilder(
        condition: state is! StoreChangeLoadingState ,
