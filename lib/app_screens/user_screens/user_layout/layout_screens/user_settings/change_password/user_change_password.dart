...
import 'cubit/user_change_password_cubit.dart';
import 'cubit/user_change_password_states.dart';
class UserChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
  create: (context) => UserChangePasswordCubit(),
  child: BlocConsumer<UserChangePasswordCubit, UserChangePasswordStates>(
  listener: (context, state) {
    var cubit = UserChangePasswordCubit.get(context);
  ...
  builder: (context, state) {
    ...
    children: [
      ...
      ConditionalBuilder(
        condition: state is! ChangeLoadingState ,
