...
import 'cubit/admin_change_password_cubit.dart';
import 'cubit/admin_change_password_states.dart';
class AdminChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
  create: (context) => AdminChangePasswordCubit(),
  child: BlocConsumer<AdminChangePasswordCubit, AdminChangePasswordStates>(
  listener: (context, state) {
    var cubit = AdminChangePasswordCubit.get(context);
  ...
  builder: (context, state) {
    ...
    children: [
      ...
      ConditionalBuilder(
        condition: state is! AdminChangeLoadingState ,
