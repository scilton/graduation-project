...
class CenterHomeLayout extends StatefulWidget {
   const CenterHomeLayout({Key? key}) : super(key: key);

  @override
  State<CenterHomeLayout> createState() => _CenterHomeLayoutState();
}

class _CenterHomeLayoutState extends State<CenterHomeLayout> {
