...
import 'change_password/center_change_password.dart';
...
class _CenterSettingsState extends State<CenterSettings> {
  ...
  listener: (context, state) {
    ...
    {
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>const CenterHomeLayout()), (route) => false);
    }
    },
