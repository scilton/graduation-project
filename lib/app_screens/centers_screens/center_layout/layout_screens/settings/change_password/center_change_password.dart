...
import 'cubit/center_change_password_cubit.dart';
import 'cubit/center_change_password_states.dart';
class CenterChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
  create: (context) => CenterChangePasswordCubit(),
  child: BlocConsumer<CenterChangePasswordCubit, CenterChangePasswordStates>(
  listener: (context, state) {
    var cubit = CenterChangePasswordCubit.get(context);
  ...
  builder: (context, state) {
    ...
    children: [
      ...
      Padding(
        padding:  EdgeInsetsDirectional.only(bottom: height*0.27),
        child: Center(
          child: Container(
            width: width * 0.766,
      ...
      ConditionalBuilder(
          condition: state is! CenterChangeLoadingState ,
